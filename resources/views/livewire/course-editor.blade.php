    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <h2 class="font-semibold text-white px-3 py-3">Courses</h2>
                <div class="p-6 text-gray-900 dark:text-gray-100 grid grid-cols-2 gap-4">
                    <form wire:submit.prevent="save">
                        ...
                        <div>
                            ...
                            <x-text-input wire:model="form.expires_at" id="expires_at" class="block mt-1 w-full" type="date" required />
                ...
                <!-- TODO Show the list of the courses -->
                <div class="space-y-6 p-6 bg-gray-800 rounded-lg shadow-lg">
                    @foreach($this->courses as $course)
                        <div class="grid grid-cols-2 gap-6 bg-gray-700 p-4 rounded-lg" wire:key="{{ $course->id }}">
